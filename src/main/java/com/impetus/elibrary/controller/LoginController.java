...
public class LoginController {
	...
	protected ModelAndView loginUser(@RequestParam String username, @RequestParam String password,
		...
		try{
			...
			if (result == true) {
				...
				loginMAV.addObject("errorMsg", "Either user name or password is incorrect!!");
				return loginMAV ;
			}
		}catch(Exception ex){
			ModelAndView loginMAV = new ModelAndView("lib_login");
